...
export default function RulebookPage() {
  return (
    <>
      {/* logo-lockup.png's background is recolored to exactly match bg-slate-950 (the page
          background), so it blends in directly with no card/tile treatment needed. */}
      <div className="mb-6 flex justify-center">
        <img src="/logo-lockup.png" alt="The LineUp — Trading Card Game" className="w-full max-w-xs" />
      </div>
      <RulebookArticle />
    </>
  )
